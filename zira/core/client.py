...
ZDEV = (5449190469, 6496589900, 6321842698)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @A7_M3\
                                  \n\n--------بـدء تتبـع سجـل دارك 𝐷𝐴𝑅𝐾--------\
                        ...
                        link = "[ძᥲᖇƙ | ɦᥲᥴƙᥱᖇ...💛](https://t.me/A7_M3)"
                        text = (
                            "**✘ تقـريـر اشعـار دارك 𝐷𝐴𝑅𝐾 ✘**\n\n"
