...
Zed_Vip = (5449190469, 6321842698, 6496589900)
zchannel = {"@D2_RK"}
...
async def autovars(): #Code by T.me/A7_M3
...
async def autoname(): #Code by T.me/A7_M3
...
async def mybot(): #Code by T.me/A7_M3
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت دارك المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس دارك الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝐷𝐴𝑅𝐾𓅛", "https://t.me/D2_RK"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كـروب السجـل دارك", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
