# D2_RK
# Copyright (C) 2023 D2_RK . All Rights Reserved
#
# This file is a part of < https://github.com/Zed-Thon/ZelZal/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/D2_RK/A7_M3/blob/master/LICENSE/>.
import requests
import asyncio
import os
import sys
...
#الملـف كتابـة دارك ⤶ @D2_RK خاص بسـورس ⤶ 𝘿𝘼𝙍𝙆
...
async def _(event):
    ...
    async with borg.conversation(chat) as conv: # code by t.me/D2_RK
        try:
...
async def linkapk(event):
    ...
    if input_str == "الحذف":
        return
    chat = "@apkdl_bot" # code by t.me/D2_RK
