...
""" 
CC Checker & Generator for 𝘿𝘼𝙍𝙆™ t.me/𝘿𝘼𝙍𝙆
Write file by Zelzal t.me/A7_M3
hhh o ya beby
...
async def song2(event):
    been = "410039xxxxxxxxxx|xx|xxxx|xxx" # code by t.me/A7_M3
    chat = "@SDBB_Bot" # code by t.me/A7_M3
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "524447000053xxxx|xx|xxxx|xxx" # code by t.me/A7_M3
    chat = "@SDBB_Bot" # code by t.me/A7_M3
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "373352589xxxxxx|xx|xxxx|xxxx" # code by t.me/A7_M3
    chat = "@SDBB_Bot" # code by t.me/A7_M3
    reply_id_ = await reply_id(event)
