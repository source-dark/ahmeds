...
#
ZelzalTHS_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝘼𝙍𝙆 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/D2_RK) 𓆪\n\n"
...
async def permalink(malath):
    ...
    if user.id in zel_dev:
        return await edit_or_reply(malath, f"**╮ ❐ لك هـذا دارك الهكر . . شما حجيت ماكـدر اوصفـه 🙊💘 ❏╰**")
    tag = user.first_name.replace("\u2060", "") if user.first_name else user.username
