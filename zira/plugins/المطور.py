...
ZelzalDV_cmd = (
    "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝘼𝙍𝙆 - اوامــر المطـور المســاعد](t.me/D2_RK) .\n\n"
...
async def add_sudo_user(event):
    ...
    output += "**⎉╎يتم الان اعـادة تشغيـل بـوت دارك انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝘿𝘼𝙍𝙆 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**⎉╎يتم الان اعـادة تشغيـل بـوت دارك انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
...
# Copyright (C) 2022 D2_RK . All Rights Reserved
