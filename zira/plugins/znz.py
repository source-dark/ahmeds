# A7_M3
# Copyright (C) 2023 A7_M3 . All Rights Reserved
#
# This file is a part of < https://github.com/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/>.
""" ™
So تخمـط الملـف اهينك واطشك للناس خماط واوثق عليك
Copyright (C) A7_M3 . All Rights Reserved
Credit: https://github.com/
Devloper: https://t.me/A7_M3"""
"""import json
import math
import asyncio
import os
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:  # Code by T.me/A7_M3
        malathid = Config.OWNER_ID
    elif query_user_id == user_id or query_user_id == int(user_id):
        malathid = user_id
    if query_user_id == Config.OWNER_ID or query_user_id == user_id or query_user_id == int(user_id) or query_user_id in Config.SUDO_USERS:  # Code by T.me/A7_M3
