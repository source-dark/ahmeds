...
async def start_vc(event):
    ...
    try:
        ...
        await edit_delete(event, "**- جـارِ فتح الكول ...**")
    except ChatAdminRequiredError:
        await edit_delete(event, "**- انت بحاجـه الى صلاحيـات المشـرف لفتح الكول ...**", time=20)
...
async def end_vc(event):
    ...
    try:
        ...
        await edit_delete(event, "**- تم قفل الكول .. بنجـاح ✓**")
    except ChatAdminRequiredError:
        await edit_delete(event, "**- انت بحاجـه الى صلاحيـات المشـرف لـ قفل الكول ...**", time=20)
