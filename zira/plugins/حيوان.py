#D2_RK ®
#الملـف حقـوق وكتابـة ძᥲᖇƙ | ɦᥲᥴƙᥱᖇ ⤶ @A7_M3 خاص بسـورس ⤶ D2_RK
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝘼𝙍𝙆 𓆪 </b> - @D2_RK "
...
async def who(event):
    ...
    zel_dev = (5449190469, 6496589900, 6321842698)
    ...
    if replied_user.id == 5449190469 or replied_user.id == 6321842698 or replied_user.id == 6496589900:
