...
ZelzalPH_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝘼𝙍𝙆 📲 - كـاشـف الارقـام العربيــة](t.me/D2_RK) 𓆪\n\n"
    "**⪼ الامــر ↵**\n\n"
...
async def _(event): #Code by T.me/A7_M3
    ...
    zelzal = "@ZZIIIbot" #Code by T.me/A7_M3
    zed = await edit_or_reply(event, "**⎉╎جـارِ الكشـف عن الرقـم 📲**\n**⎉╎انتظـر قليـلاً ... ▬▭**")
    async with borg.conversation(zelzal) as conv: # code by t.me/A7_M3
        try:
