...
""" 
Logo & Style for D2_RK™ t.me/D2_RK
Write file by Zelzal t.me/D2_RK
...
async def lg1(userevent):
    ...
    if gvarstatus("ZED_FONTS") is None: # code by t.me/D2_RK
        zed_font = await get_font_file(userevent.client, "@D2_RK")
    else:
    ...
    if userevent.reply_to_msg_id:
        ...
        async for i in bot.iter_messages(
            "@D2_RK", filter=InputMessagesFilterPhotos
        ):
            PICS_STR.append(i)
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/D2_RK
